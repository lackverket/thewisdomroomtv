...
import CommentSection from "@/app/main/[components]/CommentSection";
      ...
      {!error && !loading && (
        <section className="relative flex-1 w-full flex flex-col items-center px-10 py-4">
          ...
          <div className="mt-8 w-full flex flex-col items-start mb-5">
            <p className="leading-7 not-first:mt-6 text-[#222] whitespace-pre-wrap" >{teachingItems?.mainContent}</p>
          </div>
